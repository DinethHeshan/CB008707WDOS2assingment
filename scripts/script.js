...
var Displayproducts = products[b].value;
  }
...
var totalordervalue = mainproductprice + productsizevalue + otherproductvalue;
  ...
  "Manufacturer : " + Displaymanufacture + "<br>" + "<br>" + "Products : " + Displayproducts + "<br>" + "<br>" + "Size : " + Displaysize + "<br>" + "<br>" + "Other products : " + Displayotherproducts + "<br>" + "<br>" +  "Final Price : Rs." + totalordervalue ;                                                          
